...
$ontext
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AFG_AMDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AFG_AMDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AFG_CSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AFG_CSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AFG_FARA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AFG_FARA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AFG_HELM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AFG_HELM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AFG_INDU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AFG_INDU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AGO_ANGC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AGO_ANGC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AGO_ASII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AGO_ASII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AGO_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AGO_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AGO_ZAMB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AGO_ZAMB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ALB_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ALB_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARE_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARE_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_LAPL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_LAPL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_NASA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_NASA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_NEGR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_NEGR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_PAMP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_PAMP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_SACC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_SACC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_SASS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_SASS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARG_SGRN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARG_SGRN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ARM_CSSW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ARM_CSSW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ATG_CARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ATG_CARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_AEAC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_AEAC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_AINT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_AINT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_ASCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_ASCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_AUNC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_AUNC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_AWEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_AWEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUS_MRDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUS_MRDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AUT_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AUT_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/AZE_CSSW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms AZE_CSSW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BDI_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BDI_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BDI_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BDI_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BEL_MAAS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BEL_MAAS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BEL_SCHE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BEL_SCHE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BEN_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BEN_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BEN_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BEN_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BEN_VOLT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BEN_VOLT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BFA_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BFA_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BFA_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BFA_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BFA_VOLT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BFA_VOLT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BGD_BBCN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BGD_BBCN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BGD_GABR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BGD_GABR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BGR_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BGR_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BGR_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BGR_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BHR_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BHR_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BHS_CARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BHS_CARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BIH_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BIH_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BIH_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BIH_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BLR_DAUG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BLR_DAUG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BLR_DNIP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BLR_DNIP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BLR_NEMA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BLR_NEMA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BLZ_YUPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BLZ_YUPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BOL_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BOL_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BOL_LAPL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BOL_LAPL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BOL_LPUN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BOL_LPUN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRA_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRA_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRA_LAPL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRA_LAPL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRA_SAOF.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRA_SAOF
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRA_TOCA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRA_TOCA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRA_UBSA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRA_UBSA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BRB_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BRB_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BTN_GABR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BTN_GABR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BWA_ASII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BWA_ASII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BWA_LIMP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BWA_LIMP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/BWA_ORAN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms BWA_ORAN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAF_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAF_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAF_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAF_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_AOSB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_AOSB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_HBCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_HBCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_MACK.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_MACK
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_NWTT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_NWTT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_PACA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_PACA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_SNEL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_SNEL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CAN_STLA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CAN_STLA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHE_POOO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHE_POOO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHE_RHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHE_RHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHE_RHON.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHE_RHON
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHL_LPUN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHL_LPUN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHL_NCHI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHL_NCHI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHL_SCPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHL_SCPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_AMUR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_AMUR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_CHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_CHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_GOBI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_GOBI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_HHEE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_HHEE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_TARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_TARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CHN_YANG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CHN_YANG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CIV_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CIV_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CIV_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CIV_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CMR_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CMR_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CMR_GFGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CMR_GFGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CMR_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CMR_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CMR_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CMR_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COD_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COD_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COG_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COG_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COG_GFGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COG_GFGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COL_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COL_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COL_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COL_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COL_CEPC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COL_CEPC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COL_MAGD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COL_MAGD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COL_ORIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COL_ORIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/COM_MADA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms COM_MADA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CRI_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CRI_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CYP_MSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CYP_MSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CZE_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CZE_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CZE_ELBE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CZE_ELBE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/CZE_ODER.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms CZE_ODER
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DEU_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DEU_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DEU_DGCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DEU_DGCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DEU_ELBE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DEU_ELBE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DEU_EWES.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DEU_EWES
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DEU_RHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DEU_RHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DJI_ARGA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DJI_ARGA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DJI_RIFT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DJI_RIFT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DNK_DGCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DNK_DGCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DOM_CARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DOM_CARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DZA_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DZA_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DZA_MSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DZA_MSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/DZA_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms DZA_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ECU_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ECU_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ECU_CEPC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ECU_CEPC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/EGY_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms EGY_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/EGY_ARGA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms EGY_ARGA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/EGY_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms EGY_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_DOUR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_DOUR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_EBRO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_EBRO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_GUAD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_GUAD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_GUDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_GUDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_SPAC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_SPAC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_SSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_SSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ESP_TAGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ESP_TAGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/EST_BSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms EST_BSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/EST_NARV.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms EST_NARV
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ETH_ARGA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ETH_ARGA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ETH_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ETH_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ETH_RIFT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ETH_RIFT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ETH_SHJU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ETH_SHJU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FIN_FINL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FIN_FINL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FIN_SNCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FIN_SNCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FIN_SWED.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FIN_SWED
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FJI_SPII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FJI_SPII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_FWCX.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_FWCX
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_GIRD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_GIRD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_LOIR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_LOIR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_NESO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_NESO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_RHON.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_RHON
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/FRA_SEIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms FRA_SEIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GAB_GFGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GAB_GFGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GBR_EAWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GBR_EAWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GBR_IREL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GBR_IREL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GBR_SCTD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GBR_SCTD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GEO_BSSC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GEO_BSSC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GEO_CSSW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GEO_CSSW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GHA_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GHA_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GHA_VOLT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GHA_VOLT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GIN_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GIN_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GIN_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GIN_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GIN_SENE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GIN_SENE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GMB_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GMB_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GNB_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GNB_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GRC_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GRC_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GRD_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GRD_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GTM_GRIJ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GTM_GRIJ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GTM_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GTM_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GTM_YUPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GTM_YUPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GUY_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GUY_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/GUY_NESO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms GUY_NESO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HKG_CHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HKG_CHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HND_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HND_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HRV_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HRV_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HRV_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HRV_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HTI_CARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HTI_CARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/HUN_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms HUN_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IDN_IRJA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IDN_IRJA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IDN_JATI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IDN_JATI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IDN_KALI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IDN_KALI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IDN_SULA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IDN_SULA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IDN_SUMA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IDN_SUMA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IND_GABR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IND_GABR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IND_GODA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IND_GODA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IND_INDU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IND_INDU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IND_KRIS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IND_KRIS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IND_SABA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IND_SABA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRL_IREL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRL_IREL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRN_CIRA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRN_CIRA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRN_CSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRN_CSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRN_CSSW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRN_CSSW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRN_PGCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRN_PGCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRN_TIEU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRN_TIEU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/IRQ_TIEU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms IRQ_TIEU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ISL_ICEL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ISL_ICEL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ISR_DEAS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ISR_DEAS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ISR_MSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ISR_MSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ITA_IECO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ITA_IECO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ITA_IWCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ITA_IWCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ITA_MSII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ITA_MSII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ITA_POOO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ITA_POOO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ITA_TIBE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ITA_TIBE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/JAM_CARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms JAM_CARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/JOR_DEAS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms JOR_DEAS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/JOR_EJSS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms JOR_EJSS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/JOR_SIPE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms JOR_SIPE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/JPN_JAPN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms JPN_JAPN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KAZ_CSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KAZ_CSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KAZ_CSPC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KAZ_CSPC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KAZ_LKBH.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KAZ_LKBH
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KAZ_OBBB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KAZ_OBBB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KAZ_SYRD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KAZ_SYRD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KEN_AECC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KEN_AECC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KEN_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KEN_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KEN_RIFT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KEN_RIFT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KEN_SHJU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KEN_SHJU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KGZ_LKBH.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KGZ_LKBH
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KGZ_SYRD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KGZ_SYRD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KGZ_TARI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KGZ_TARI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KHM_GTCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KHM_GTCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KHM_MEKO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KHM_MEKO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KOR_NSKU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KOR_NSKU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KWT_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KWT_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/KWT_TIEU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms KWT_TIEU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LAO_MEKO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LAO_MEKO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LAO_VNCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LAO_VNCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LBN_DEAS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LBN_DEAS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LBN_MSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LBN_MSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LBR_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LBR_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LBY_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LBY_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LBY_MSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LBY_MSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LCA_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LCA_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LKA_SRIL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LKA_SRIL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LSO_ORAN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LSO_ORAN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LTU_BSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LTU_BSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LTU_NEMA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LTU_NEMA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LUX_RHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LUX_RHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LVA_BSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LVA_BSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/LVA_DAUG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms LVA_DAUG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MAC_XJIA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MAC_XJIA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MAR_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MAR_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MAR_ANWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MAR_ANWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MAR_MSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MAR_MSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MDA_BSNC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MDA_BSNC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MDA_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MDA_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MDA_DNIE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MDA_DNIE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MDG_MADA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MDG_MADA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_BJCA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_BJCA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_MCIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_MCIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_MNCW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_MNCW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_RGBV.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_RGBV
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_RIBA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_RIBA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_RIVE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_RIVE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_RLER.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_RLER
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MEX_YUPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MEX_YUPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MKD_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MKD_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MLI_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MLI_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MLI_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MLI_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MLI_SENE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MLI_SENE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MLT_MSII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MLT_MSII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MMR_BBCN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MMR_BBCN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MMR_IRRA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MMR_IRRA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MMR_PMAL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MMR_PMAL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MMR_SALW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MMR_SALW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MMR_SITT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MMR_SITT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MNE_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MNE_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MNE_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MNE_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MNG_AMUR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MNG_AMUR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MNG_GOBI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MNG_GOBI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MNG_YENS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MNG_YENS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MOZ_AECC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MOZ_AECC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MOZ_AIOC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MOZ_AIOC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MOZ_LIMP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MOZ_LIMP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MOZ_ZAMB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MOZ_ZAMB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MRT_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MRT_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MRT_ANWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MRT_ANWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MRT_SENE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MRT_SENE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MWI_AECC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MWI_AECC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MWI_ZAMB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MWI_ZAMB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MYS_NBCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MYS_NBCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/MYS_PMAL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms MYS_PMAL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NAM_ASII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NAM_ASII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NAM_NAMC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NAM_NAMC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NAM_ORAN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NAM_ORAN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NER_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NER_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NER_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NER_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NGA_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NGA_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NGA_GFGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NGA_GFGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NGA_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NGA_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NGA_NIGE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NGA_NIGE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NIC_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NIC_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NLD_MAAS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NLD_MAAS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NLD_RHIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NLD_RHIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NLD_SCHE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NLD_SCHE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NOR_SNCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NOR_SNCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NOR_SWED.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NOR_SWED
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NPL_GABR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NPL_GABR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/NZL_NZLZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms NZL_NZLZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/OMN_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms OMN_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAK_ASAC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAK_ASAC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAK_HAMU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAK_HAMU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAK_INDU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAK_INDU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAK_SABA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAK_SABA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAN_CEPC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAN_CEPC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PAN_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PAN_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PER_AMAZ.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PER_AMAZ
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PER_PERU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PER_PERU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PHL_PHIL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PHL_PHIL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PNG_FLYY.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PNG_FLYY
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PNG_IRJA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PNG_IRJA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PNG_PNGC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PNG_PNGC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PNG_SEPI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PNG_SEPI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/POL_ODER.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms POL_ODER
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/POL_PLCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms POL_PLCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/POL_WISL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms POL_WISL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PRT_DOUR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PRT_DOUR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PRT_GUAD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PRT_GUAD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PRT_SPAC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PRT_SPAC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PRT_TAGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PRT_TAGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/PRY_LAPL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms PRY_LAPL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/QAT_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms QAT_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ROU_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ROU_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_AMUR.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_AMUR
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_LENA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_LENA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_OBBB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_OBBB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_SNCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_SNCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_SWCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_SWCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_VOLG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_VOLG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RUS_YENS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RUS_YENS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RWA_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RWA_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/RWA_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms RWA_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SAU_ARPA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SAU_ARPA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SAU_RSEE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SAU_RSEE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SDN_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SDN_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SDN_ARGA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SDN_ARGA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SDN_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SDN_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SDN_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SDN_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SEN_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SEN_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SEN_SENE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SEN_SENE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SLB_SOLI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SLB_SOLI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SLB_SPII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SLB_SPII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SLE_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SLE_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SLV_SCAM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SLV_SCAM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SRB_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SRB_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/STP_GFGU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms STP_GFGU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SUR_NESO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SUR_NESO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SVK_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SVK_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SVN_AGBS.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SVN_AGBS
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SVN_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SVN_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SWE_SWED.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SWE_SWED
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/SWZ_SASC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms SWZ_SASC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TCD_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TCD_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TCD_LCHA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TCD_LCHA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TGO_AFWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TGO_AFWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TGO_VOLT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TGO_VOLT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/THA_CHAO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms THA_CHAO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/THA_GTCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms THA_GTCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/THA_MEKO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms THA_MEKO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/THA_PMAL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms THA_PMAL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TJK_AMDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TJK_AMDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TJK_SYRD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TJK_SYRD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TKM_AMDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TKM_AMDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TKM_CSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TKM_CSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TLS_JATI.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TLS_JATI
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TTO_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TTO_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUN_ANIN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUN_ANIN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUN_MSCC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUN_MSCC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUR_BSSC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUR_BSSC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUR_CSSW.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUR_CSSW
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUR_MSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUR_MSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TUR_TIEU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TUR_TIEU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TZA_AECC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TZA_AECC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TZA_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TZA_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TZA_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TZA_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/TZA_RIFT.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms TZA_RIFT
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UGA_NILE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UGA_NILE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UKR_BSNC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UKR_BSNC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UKR_DANU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UKR_DANU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UKR_DNIE.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UKR_DNIE
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UKR_DNIP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UKR_DNIP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UKR_DONN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UKR_DONN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/URY_LAPL.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms URY_LAPL
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/URY_UBSA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms URY_UBSA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_COLU.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_COLU
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_GFCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_GFCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_GMAN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_GMAN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_MSMM.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_MSMM
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_NACC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_NACC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/USA_PACA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms USA_PACA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UZB_AMDA.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UZB_AMDA
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UZB_CSEC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UZB_CSEC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/UZB_SYRD.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms UZB_SYRD
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/VCT_CARC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms VCT_CARC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/VNM_HRIV.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms VNM_HRIV
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/VNM_MEKO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms VNM_MEKO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/VNM_VNCO.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms VNM_VNCO
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/VUT_SPII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms VUT_SPII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZAF_LIMP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZAF_LIMP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZAF_ORAN.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZAF_ORAN
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZAF_SASC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZAF_SASC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZAF_SAWC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZAF_SAWC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZMB_CONG.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZMB_CONG
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZMB_ZAMB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZMB_ZAMB
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZWE_AIOC.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZWE_AIOC
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZWE_ASII.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZWE_ASII
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZWE_LIMP.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZWE_LIMP
$if exist '../output/gdx/%SCE%_%CLP%_%IAV%%ModelInt%/_cbnal/ZWE_ZAMB.gdx' $batinclude ../%prog_loc%/inc_prog/combineR.gms ZWE_ZAMB
$offtext
$onlisting
$endif.cmbr
