...
scn=(   SSP2_BaU_NoCC_No \
        SSP2_BaU_BIOD_No \        
        SSP2_500C_CACN_DAC_NoCC_No \
        SSP2_500C_CACN_DAC_BIOD_No \
       SSP2_SDGLand_BaU_BIOD_No \
        SSP2_SDGLand_BaU_NoCC_No \
        SSP2_SDGLand_500C_CACN_DAC_NoCC_No \
       SSP2_SDGLand_500C_CACN_DAC_BIOD_No)
scn=(   SSP2_BaU_NoCC_No \
        SSP2_BaU_BIOD_No \    
       SSP2_SDGLand_500C_CACN_DAC_BIOD_No)
scn=( SSP2_400C_2020NDC_NoCC_scenarioMIP_global2)
scn=( SSP2_BaU_NoCC_No \
      SSP1_BaU_NoCC_ScenarioMIP_global2 \
