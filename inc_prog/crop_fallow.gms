...
Y_NPROTCROP_FLWG(G)$(Y_NPROT_NOPAS(G) and Y_NPROT_NOPAS(G) - VYL("CROP_FLW",G)>0)=Y_NPROT_NOPAS(G) - VYL("CROP_FLW",G);
...
Y_NPROTCROP_FLW=SUM(G$(VYL("FRSGL",G)-VYL("CROP_FLW",G)-protect_wopas(G)>0),VYL("FRSGL",G)-VYL("CROP_FLW",G)-protect_wopas(G));
