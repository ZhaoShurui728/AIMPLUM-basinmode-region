...
#    rm $3 ../output/cdl/$1_$2.cdl
  ...
  #For LUMIP 
  if [ ${lumip} == on ]; then
    filelist="../output/csv/${SceName}/c3ann.csv ../output/csv/${SceName}/c3per.csv ../output/csv/${SceName}/c4ann.csv ../output/csv/${SceName}/c4per.csv ../output/csv/${SceName}/c3nfx.csv ../output/csv/${SceName}/crpbf_c4per.csv ../output/csv/${SceName}/irrig_c3ann.csv ../output/csv/${SceName}/irrig_c3per.csv ../output/csv/${SceName}/irrig_c4ann.csv ../output/csv/${SceName}/irrig_c4per.csv ../output/csv/${SceName}/irrig_c3nfx.csv ../output/csv/${SceName}/pastr.csv ../output/csv/${SceName}/primf.csv ../output/csv/${SceName}/primn.csv ../output/csv/${SceName}/range.csv ../output/csv/${SceName}/secdf.csv ../output/csv/${SceName}/secdn.csv ../output/csv/${SceName}/urban.csv ../output/csv/${SceName}/flood.csv ../output/csv/${SceName}/fallow.csv ../output/csv/${SceName}/icwtr.csv ../output/csv/${SceName}/rice.csv ../output/csv/${SceName}/wheat.csv ../output/csv/${SceName}/maize.csv ../output/csv/${SceName}/sugarcrops.csv ../output/csv/${SceName}/oilcrops.csv ../output/csv/${SceName}/othercrops.csv"
